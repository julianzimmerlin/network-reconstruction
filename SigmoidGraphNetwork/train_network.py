...
USE_GPU = True
SERIES_ADDRESS = '../data/final/cml/timeseries_ba20_5k_4_restart.pickle'
...
for _ in range(EXPERIMENTS):
    logger = lo.Logger('GGN_logs/final/cml_ba20_5k_4_restart' if USE_GUMBEL else 'SGN_logs/EXP_SIS_FIXED_ba10', original_terminal=orig_terminal)
    sys.stdout = logger
